...
int main()
{
    ...
    FILE *raw_file = fopen("merge-bubble-raw_times.csv", "w");
    FILE *summary_file = fopen("merge-bubble-summary_results.csv", "w");
    ...
    printf("\nResultados salvos em 'merge-bubble-raw_times.csv' e 'merge-bubble-summary_results.csv'.\n");
    return 0;
}
